...
var _require = require('./pino/logger.js'),
  pinoLogger = _require.logger;

// Use a Singleton pattern to ensure that the PQueue is only imported once.
var PQueueInstance;
var OverflowQueueHandler = /*#__PURE__*/function () {
  function OverflowQueueHandler(options) {
    _classCallCheck(this, OverflowQueueHandler);
    if (!PQueueInstance) {
    ...
    this.worker = worker;
    this.queue = new PQueueInstance({
      concurrency: concurrency
    });

    // Register listeners for logging
    this.queue.on('add', function () {
      pinoLogger.info("Task added to the queue.");
    });
    this.queue.on('next', function () {
      pinoLogger.info("Task completed.");
    });
  }
  _createClass(OverflowQueueHandler, [{
    key: "addToQueue",
    value: function () {
      var _addToQueue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(item) {
        var _this = this;
        var errorMessage;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              errorMessage = "Failed to add task to overflow queue: Missing task data.";
            ...
            case 10:
              ...
              pinoLogger.error("Error processing task: ".concat(_context.t0.message));
              throw _context.t0;
            case 14:
            case "end":
    ...
    key: "drain",
    value: function () {
      var _drain = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return Promise.resolve().then(function () {
                return _interopRequireWildcard(require('p-queue'));
              });
            case 3:
              PQueueInstance = _context3.sent["default"];
